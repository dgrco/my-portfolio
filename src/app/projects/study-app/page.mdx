export const metadata = {
  ...
  cover: "/tolari-app.png",
  coverAlt:
    "Four Tolari views: a flashcard front, the answer with spaced-repetition recall grading, the Kanban planning board, and the pomodoro timer",
}
